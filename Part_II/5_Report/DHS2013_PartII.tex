...
\multirow{2}{*}{Experiment} 	& Fire Attack 	& \multirow{2}{*}{Nozzle}		& \multirow{2}{*}{Advancement} 		& \multirow{2}{*}{Pattern}		& \multicolumn{1}{c|}{\multirow{2}{*}{Ventilation Parameters}} \\ 
								& 	Method	   	& 								& 									& 								& 										\\ 
\hline \hline
\multirow{2}{*}{1}	& \multirow{2}{*}{Interior} & \multicolumn{3}{c|}{Delayed water application w/ Combination;} 									& \multirow{2}{*}{Flow path between front door \& BR1 fire} \\
...
Experiment~1 was intended to examine the fire dynamics in a typical single-story structure with delayed water application. The fire was ignited in Bedroom~1 and developed until it became ventilation limited. Then, the front door was opened to simulate fire department arrival. The open door established a flow path between itself and Bedroom~1. Once the fire reached steady state, suppression was performed via the front door with a combination nozzle on straight stream. The nozzle was shutdown as the line advanced. 
...
\subsection{Exterior Attack at Bedroom~1 Window Followed by Additional Attack}
...
\begin{figure}[!ht]
	...
	% NEED TO MAKE CAPTION LABEL FOR THE FIGURES IN THIS COMPARISON
...
Plots of temperatures measured at the end of the hall and the Bedroom~4 temperatures for Experiments~22 and 24 are very similar. The temperatures at the end of the hall slightly decreased in response to the initial exterior suppression event and nearly returned to their original values before the next intervention in each experiment. The hall temperatures decreased significantly in response to the second suppression event performed in each experiment. However, they declined at a faster rate in response to the hall suppression event during the interior attack in Experiment~22. Additionally, after the second exterior attack in Experiment~24, the hall temperatures at 7~ft and 5~ft began to increase and return to their values before suppression. The hallway temperatures decreased permanently after the crew executed an interior attack after the two exterior attacks.

***NOT SURE IF BR4 TEMPS ARE NECESSARY, SO I DIDN'T MENTION THEM SPECIFICALLY IN THE DISCUSSION***
...
Figure \ref{fig:push_fire_dead_end_fog} shows the change in velocity at the bedroom 1 doorway and the start of the hallway when a fog stream is used on the exterior window, the fire is permitted to re-grow, then a straight stream is used. The straight stream resulted in water hitting the velocity probes in the bedroom 1 doorway and the data after the second water application is inaccurate.  

\begin{figure}[H]
\centering
\includegraphics[width=0.30\textwidth]{../0_Images/Script_Figures/Experiment_Analysis/Pushing_Fire/Experiment_19/Bedroom_1_Door}
\includegraphics[width=0.30\textwidth]{../0_Images/Script_Figures/Experiment_Analysis/Pushing_Fire/Experiment_19/Start_Hall_Flow}
\caption[Gas Velocities - Single Room of Fire - Exterior Fog]{Gas velocities at the Start of Hall for exterior water application with a fog stream vs. a straight stream one room of fire and a single window vent. The front door is closed. The blue shaded areas represent where water was flowing from the hose stream. The gray area indicates data that is not accurate due to water hitting the velocity probes.}
\label{fig:push_fire_dead_end_fog}
\end{figure}

The fog stream in the window is capable of pushing products of combustion into the hallway, however further down the hallway at the start of the hall, the fog suppression has an opposite effect, where it stops the flow into the living room. The straight stream hits the velocity probes at the door, however at the start of the hallway the results of a fog stream and a straight stream have the same effect of contraction and cooling, stopping the flow down the hall. 

\section{Impact of ``Whip'' on Regrowth}
During all experiments that used an exterior fire attack method, an interior attack was performed after the exterior suppression event(s) to completely extinguish the fire. In nearly every one of these experiments, the temperature measured 7~ft above the fire room floor started to increase in the time between the end of exterior suppression and start of interior suppression, indicating the exterior attack hadn't fully extinguished the fire and that it was beginning to regrow. The regrowth intensity of the fire was quantified as the difference between the maximum and minimum temperatures measured 7~ft above the floor in the fire room during this period divided by the total duration of the period.

The order of suppression events performed during Experiments~18 and 20 was an exterior attack through the window of Bedroom~1 followed by an interior attack to completely extinguish the fire. Additionally, both experiments used a smooth bore nozzle to flow water and contained the `Single Vent' configuration. The main difference between Experiments~18 and 20 is that towards the end of the initial suppression event during Experiment~20, the nozzle was advanced forward through the window opening and water was applied in a ``whip'' pattern with the bale half closed, whereas during Experiment~18, no nozzle movement occurred. Comparing the fire regrowth intensity during the two experiments, the rate of temperature increase during the fire regrowth period for Experiment~20 was 1.0~$^\circ$F/sec less than the rate of temperature increase during the regrowth period for Experiment~18.

Experiment~24 used the `Two Vent' configuration, which contained two fire rooms: Bedroom~1 and Bedroom~2. The initial suppression event performed during Experiment~24 was an exterior attack through the window of Bedroom~1, followed by an exterior attack through the window of Bedroom~2 and a final interior attack to completely extinguish the fire. A combination nozzle was used to flow water in a straight stream pattern. Towards the end of each exterior suppression event, the nozzle was advanced forward through the window opening and water was applied as a narrow fog in a ``whip'' pattern. Two fire regrowth intensities were calculated for Experiment~24---one for each fire room. The initial suppression event performed during Experiment~27 was an exterior attack through the window of Bedroom~4, the fire room, followed by an interior attack to completely extinguish the fire. A combination nozzle was used to flow water in a straight stream pattern during Experiment~27, and the exterior attack did not include water application in the ``whip'' pattern towards the end of the suppression event.
...
Overall, the temperature rise during the time between the end of the exterior attack and start of interior suppression occurred at a slower rate and was less drastic for experiments that included a nozzle ``whip'' towards the end of exterior suppression compared to experiments that did not involve a ``whip'' at the end of exterior suppression. Using the ``whip'' pattern allowed water to reach a larger surface area of the fuel.

\section{Impact of Door Control}
Controlling the access door was a tactical consideration from the DHS-2010 `Study of the Effectiveness of Fire Service Vertical Ventilation and Suppression Tactics in Single Family Homes.' When gaining access the open front door provided oxygen to the ventilation limited fire, causing the fire to grow and spread. To access the impact door control has a on a bedroom fire with a long hallway four experiments were conducted two with the bedroom window closed (No Vent) and two with the bedroom window open (Single Vent). In each case the fire room temperatures gas velocity at the start of the hallway and the heat flux to the floor were compared to determine the effect maintaining door control had on the fire prior to suppression activities commencing. 

\subsection{No Vent}
To evaluate the impact of door control experiment 6 which included door control is compared to experiment 3, where no door control was provided. Figure X below shows the fire room temperatures for Experiment 3 and Experiment 6.  
