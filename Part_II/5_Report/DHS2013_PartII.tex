...
The use of door control had more effect on teh flow when there was ventilation provided oppsite the attach team. The velocity of air being drawing towards the fire in experioment 14 was significatnly more than in experiment 15. Once the line was opened down the hallway it sealed the hallway much like the no vent oppsite case, and negated the flow. Door control is a potential viable tactic to limit the air drawn towards the fire until the attack team can being flowing water from a position between the entry door at the fire.   
