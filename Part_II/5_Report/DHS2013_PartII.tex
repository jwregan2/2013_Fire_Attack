...
The application of water from the exterior has the potential to alter the flow of the products of combustion. When a solid stream or straight stream are utilized, the flow from the fire room to the remainder of the structure is minimal. When a fog nozzle is utilized, there is potential for flow to enter the 
...
After the initial water application from the exterior it is possible fire will still be located under and behind objects which will cause the room to re-grow while the crew positions for final suppression. Figure X shows ten second increments prior, during and after an initial exterior water application. 
