...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/MLR_HRR/all_sofa_HRR_MLR.png}
...
\caption{Cross Section of Human Skin \cite{Hummel_Barker_Lyons}}
