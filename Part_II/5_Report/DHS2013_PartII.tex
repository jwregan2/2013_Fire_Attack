...
Throughout the full-scale fire experiments, thermal imagers were used in both a static and dynamic manner. Sixteen video feeds, including two thermal imaging views, were captured and recorded for each of the experiments. One thermal view was from the interior looking down the hallway towards the fire room and one was from the exterior looking at the front side of the structure encompassing both the front door and window to the fire room within the field of view. Additionally, a hand-held thermal imager was utilized by the firefighting crews engaged during the experiment for both safety purposes and to ensure complete knockdown and extinguishment. The thermal imagers utilized during this study were standard equipment readily available for purchase and use by the fire service worldwide. 

In post processing the experiment video, several of the limitations of thermal imaging use during firefighting operations were confirmed. As outlined within NFPA 1408: Training Fire Service Personnel in the Operation, Care, Use, and Maintenance of Thermal Imagers, all personnel using thermal imagers must understand their use and limitations. Thermal imagers are designed to detect radiant thermal energy emitted from solid surfaces, particulates, and some gases utilizing a constant emissivity value. Emissivity is defined as the ratio of the energy radiated from a material`s surface to that of a blackbody, or perfect emitter, at the same temperature. The emissivity of the surfaces and gases radiating energy during a fire affect the thermal imager`s ability to determine the actual temperature and can be misleading to the firefighters utilizing the device. As the emissivity value of radiating objects within a fire diverge from the imager`s constant value, the temperature readout becomes more and more inaccurate. 

Furthermore, the fire environment within a structure is always changing, especially with ongoing fire department interventions. There are situations in which a thermal imager can be ``looking through'' smoke to a surface beyond which could be at a significantly different temperature than that of the gases. With regards to the fire experiments, this was evident through looking at the thermal imaging view from the camera located on the interior of the structure looking down the hallway towards the fire room and comparing the temperature readout with the thermocouple temperatures located in the same vicinity as seen in figure \ref{fig:IR_temp_comparison}.
