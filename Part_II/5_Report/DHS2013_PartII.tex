...
1\textsuperscript{st} degree 	& Superficial burns			& > 0.2 Surface Necrosis 								\\ \hline
2\textsuperscript{nd} degree 	& Partial thickness burns 	& > 0.2 Surface Necrosis but < 2~mm Necrosis Depth 		\\ \hline
...
\multirow{6}{*}{No Vent Interior}  		&	1*   			& 4\textsuperscript{th} degree 	& 4\textsuperscript{th} degree 	& 3\textsuperscript{rd} degree 	& 3\textsuperscript{rd} degree 	\\ \cline{2-6}
...
\multirow{4}{*}{Two Vent Transitional}	& 	18   			& 2\textsuperscript{nd} degree 	& 2\textsuperscript{nd} degree 	& No Damage 					& No Damage 					\\ \cline{2-6}
										&	19   			& 1\textsuperscript{st} degree 	& 1\textsuperscript{st} degree 	& No Damage 					& No Damage 					\\ \cline{2-6}
										&	20   			& No Damage 					& No Damage 					& No Damage 					& No Damage 					\\ \cline{2-6}
										&	21   			& No Damage 					& No Damage 					& No Damage 					& No Damage 					\\ \hline
\multirow{3}{*}{Two Vent Transitional}	& 	22   			& 3\textsuperscript{rd} degree 	& 3\textsuperscript{rd} degree 	& 1\textsuperscript{st} degree 	& 1\textsuperscript{st} degree 	\\ \cline{2-6}
										&	23   			& 3\textsuperscript{rd} degree 	& 3\textsuperscript{rd} degree 	& No Damage 					& No Damage 					\\ \cline{2-6}
...
\multirow{4}{*}{Two Vent Transitional}	& 	18   			&  1.010 		& 1.010 								& 0.300 						&  1.000			\\ \cline{2-6}
...
\multirow{4}{*}{Two Vent Transitional}	& 	18   			& 0.002 		& 0.033 								& 0.000 						& 0.000				\\ \cline{2-6}
...
No potential burn injuries were observed at the victims located remote from the fire (Victim 4 and Victim 5) and at the victim located behind a closed door (Victim 2). The victim immediately outside the fire compartments (Victim 1) and the victim in the adjacent bedroom on the bed (Victim 3) both had potential burn injuries. When fire department intervention was delayed, these locations received 3\textsuperscript{rd} and 4\textsuperscript{th} degree burns. Table \ref{tab:TC_burn_inj_potential} shows the potential injury to unprotected skin when suppression is delayed.
...
*********************************************************************************************************************************************************
***************************						NEED TO FINISH THIS TACTICAL CONSIDERATION 					*********************************************
*********************************************************************************************************************************************************
*********************************************************************************************************************************************************
*********************************************************************************************************************************************************
*********************************************************************************************************************************************************
