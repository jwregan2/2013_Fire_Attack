...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{../0_Images/Script_Figures/Repeatibility/No_Vent_Temperature}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{../0_Images/Script_Figures/Repeatibility/Single_Vent_Temperature}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{../0_Images/Script_Figures/Repeatibility/Two_Vent_Temperature}
...
Two methods exist for estimating the effective dose heat energy received over time, one based on gas temperature and one based on the total heat flux. The 
method based on total energy flux the exposure $q$ flux in time $t$ to the four thirds power, multiplied by the exposure time $t$, all divided by the heat exposure dose for the endpoint of fatality ($16.7)
...
This section will analyze the experiments conducted for survivability based on temperature an tenability based on gas concentrations in the period prior to fire department arrival and then as they relate to the possible fire suppression tactics. 
