...
In the following section, the time to ``knock back'' the fire is compared between the experiments in five different groups that were formed based on fire attack method. Three of the sets involved an interior fire attack method, and two sets involved an exterior fire attack method. The differentiating factor between the experiments within each group is the ventilation profile. The following subsections use the temperature data from experiments to determine how ventilation profile affects the ability of the different attack methods to knock back the fire. 
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Knock_Back/Experiment_2_Bedroom_1_Temps}
	\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Knock_Back/Experiment_7_Bedroom_1_Temps}
	\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Knock_Back/Experiment_13_Bedroom_1_Temps}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Knock_Back/Experiment_6_Bedroom_1_Temps}
	\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Knock_Back/Experiment_8_Bedroom_1_Temps}
	\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Knock_Back/Experiment_14_Bedroom_1_Temps}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Knock_Back/Experiment_11_Bedroom_1_Temps}
	\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Knock_Back/Experiment_16_Bedroom_1_Temps}
...
\subsection{Exterior Attack at Bedroom~1 Window}
The fourth set of experiments is composed of Experiments~18, 20, 22, and 24, which all began with an exterior attack at  

\begin{figure}[H]
	\centering
	\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Knock_Back/Experiment_18_Bedroom_1_Temps}
	\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Knock_Back/Experiment_20_Bedroom_1_Temps}
	\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Knock_Back/Experiment_22_Bedroom_1_Temps}
	\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Knock_Back/Experiment_24_Bedroom_1_Temps}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Knock_Back/Experiment_22_Bedroom_1_Temps_full}
	\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Knock_Back/Experiment_22_Bedroom_2_Temps_full}
	\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Knock_Back/Experiment_24_Bedroom_1_Temps_full}
	\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Knock_Back/Experiment_24_Bedroom_2_Temps_full}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Knock_Back/Experiment_22_End_Hall_Temps_full}
	\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Knock_Back/Experiment_22_Bedroom_4_Temps_full}
	\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Knock_Back/Experiment_24_End_Hall_Temps_full}
	\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Knock_Back/Experiment_24_Bedroom_4_Temps_full}
