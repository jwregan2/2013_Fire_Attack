...
The results of the Striped Chair heat release rate characterization experiments are shown in Figure \ref{fig:striped_chair_HRR} along with a photo of the striped chair. The growth of the Striped Chair was very similar between both chairs tested with peak heat release rates occurring within 250 seconds to 500~seconds after ignition. Results for peak heat release rate were within 54.3~kW between minimum and maximum, the total energy released was within 100~MJ. 
...
\begin{itemize}
	...
	\item{Reposition hoseline to front door while evaulating condtions at the door.}
	\item{Front door open.}
