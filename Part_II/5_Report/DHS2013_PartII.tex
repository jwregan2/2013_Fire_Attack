...
\begin{table}[H]
	...
	4 		&	1.67    & N/A (N/A)  	& N/A (N/A) 	& 4.10 (2.43)   \\ \hline
	6 		&	1.09    & 4.40 (3.31)  	& 4.39 (3.29) 	& 4.94 (3.85)   \\ \hline
	Average &	1.38    & 4.40 (3.31)  	& 4.39 (3.29) 	& 4.52 (3.14)   \\ \hline \hline
	...
	Average &	1.12 	& 1.11 (-0.01)  & 1.80 (0.68) 	& 2.98 (1.86)   \\ \hline \hline
	\multicolumn{5}{|c|}{Single Vent - 2~ft 6~in} \\ \hline
	20		&	1.96 	& 2.17 (0.21) 	& 4.09 (2.13) 	& 5.84 (3.88)   \\ \hline \hline
	\multicolumn{5}{|c|}{Single Vent - 4~ft 6~in} \\ \hline
	...
	Average &	1.93 	& 4.62 (2.69)  	& 6.62 (4.70) 	& 8.37  (6.44)  \\ \hline \hline
	\multicolumn{5}{|c|}{Two Vent - 1~ft}        \\ \hline
	16		&	1.48 	& 3.37 (1.89) 	& 3.57 (2.09) 	& 3.99 (2.50)   \\ \hline \hline
	\multicolumn{5}{|c|}{Two Vent - 2~ft 6~in}    \\ \hline
	13		&	1.56 	& N/A  (N/A) 	& N/A (N/A)   	& 5.62 (4.07)   \\ \hline 
	\end{tabular}
	\label{tab:water_vapor_summary}
\end{table}

Increases in water vapor appeared to correlate with the smoke layer descending in the room where the water vapor was measured. The measurements taken higher in the space (in the smoke layer) resulted in higher values being recorded. The laser measurement technique often encountered a low transmission level (due to smoke obscuration) prior to the end of the experiment, resulting in an incomplete time history for moisture. Once the smoke cleared the transmission level often increased and the signal returned.  Figure \ref{fig:moisture_plots} shows the time history of each moisture measurement grouped by the ventilation configuration and elevation of the reading.
...
\caption[Laser Moisture Measurements]{Laser moisture measurements for experiments were data was obtained. No vent case - 1~ft (top left), single vent case - 1~ft (top right), single vent case 2~ft 6~in (middle left), single vent case - 4~ft 6~in (middle right), two vent case 1~ft (bottom left), two vent case 2~ft 6~in (bottom right). Vertical line with experiment number is the initial water application. Gaps in time history represent measurements }
\label{fig:moisture_plots}
\end{figure}

In Experiments~6,~18~,~19 moisture was recorded throughout the entire experiment. The measurement did not exceed 4\% by volume at the 1~ft level. This is consistent with other ventilation configurations where the sensor was located at 1~ft.  When the sensor was moved vertically in the space the moisture measurement increased, and at the 4~ft 6~in level the maximum recorded was greater than 11\%.  
...
\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Experiment_Analysis/Thermal_Class/Experiment_17_Thermal_Exposure} 
