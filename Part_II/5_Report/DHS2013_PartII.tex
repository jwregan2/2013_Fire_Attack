...
Once the experiments were complete, post processing of video was completed to determine the time it took to carry out different fire ground actions. These included the following: time to complete a given suppression tactic, travel time of firefighters on both the exterior and interior of the structure, and the time to reach various victim locations. Once on the interior of the structure, the firefighters path of travel while advancing the hoseline took them past Victim packages 4 and 1. Victim package 4 was located to the right of the start of the hallway, inside the living room and was reached first by the advancing hose crew. Victim package 1 was located at the end of the hallway, just outside of Bedroom 2. Figure \ref{fig:victims} shows these locations with reference to the structure and path of advancement.
...
The tables below show the various times separated by attack type 1) Interior Shutdown and Move, 2) Interior flow and move, and 3) Exterior (Transitional). The description of how the times were derived is as follows:
