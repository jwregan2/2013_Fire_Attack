...
The fire suppression methods tested were two versions of interior suppression, the first incorporating the flow \& move tactic and the second incorporating the shutdown \& move tactic. The transitional suppression method incorporated two variations, one where water was applied through the window on to the burning surfaces and one where it was not. Each tactic was conducted with a single room of fire with no ventilation, a single room of fire with a single window vent and two rooms of fire with two window vents. An additional variable was the nozzle type which was varied between smooth bore, and combination. Additionally an experiment looked at the impact of door control.
...
\begin{table}[H]
\centering
\begin{tabular}{|c|C{0.15\textwidth}|c|c|c|c|}
\hline
\multicolumn{2}{c|}{}								& \multicolumn{2}{|c|}{Location 1}	 												& \multicolumn{2}{|c|}{Location 3}  							\\ \cline{3-6}
Test Type 	& Suppression Tactic 					& Pre-Water 							&  Post-Water								& Pre-Water						& Post-Water 					\\ \hline
\multirow{4}{*}{1}	& \multirow{3}{*}{Interior}		& (3) 1$^{st}$ degree 					& (1) 2$^{nd}$ degree 						& (1) 2$^{nd}$ degree 			& (1) 2$^{nd}$ degree 			\\ 
					...
					&								&										& (1) no damage 							& (2) 2$^{nd}$ degree 			&								\\ \cline{2-6}
...
In Experiments~6,~18~,~and~19 moisture was recorded throughout the entire experiment. The measurement did not exceed 4\% by volume at the 1~ft level. This is consistent with other ventilation configurations where the sensor was located at 1~ft.  When the sensor was moved vertically in the space the moisture measurement increased, and at the 5~ft level the maximum recorded was greater than 11\%.  
...
As the moisture was measured at higher elevations in the space, more moisture was detected. On average the maximum moisture measured at the 1~ft level was 4.52\% by volume in the no vent case, 2.98\% by volume in the single vent case and 3.99\% in the two vent case. Compared to the 5~ft single vent case were the average was approximately double that at 8.37\% by volume. When the measurement was taken at the 1~ft level there was limited increase in moisture content between 5~seconds prior to suppression and 60~seconds after suppression. At the higher elevations in the space (in the smoke layer) the moisture would increase between approximately 2\% by volume during the period between 5~seconds prior to and 60~seconds after suppression however it would increase by a similar amount from ignition until the time of 5~seconds prior to suppression. 
