...
As seen in the figure above, a screenshot capture of the thermal imaging view from inside the structure shows the end of the hallway at what appears to be a temperature of 136 degrees Fahrenheit at 5 minutes and 30 seconds into the test. The end hall thermocouple temperatures in the same vicinity are showing temperatures from floor to ceiling of well above 500 degrees Fahrenheit at the same time frame. This can be misleading to firefighters operating within the structure who may be making decisions on advancement and suppression based upon the temperature readout from the thermal imager.

The following is a list of recommendations in the use of thermal imaging cameras for structural firefighting operations:
\hl{Is this how we are recommending using them?}
\begin{itemize}
	\item{Thermal imagers are unreliable thermometers.}
	\item{Thermal imagers should be utilized to look for thermal contrasts, movement of heated gases, and heat signatures.}
