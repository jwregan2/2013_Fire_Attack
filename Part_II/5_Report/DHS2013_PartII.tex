...
\hline
\multirow{2}{*}{5}	& \multirow{2}{*}{Interior} & \multirow{2}{*}{Combination} 	& \multirow{2}{*}{Shutdown \& Move} &  Straight Stream, near to far 		& \multirow{2}{*}{Flow path between front door \& BR1 fire} \\
...
\centering
\scalebox{0.75}{
\begin{tabular}{|c|C{.09\textwidth}|c|C{0.26\textwidth}|C{0.24\textwidth}|L{0.25\textwidth}|}
\hline
Experiment 	& Fire Attack Method & Nozzle			& Advancement 													& Pattern																& Ventilation Parameters 					\\ \hline \hline
18			& Exterior 			 & Smooth bore 		& Steep angle 													& Solid stream  														& Flow path between BR1 fire \& BR1 window 	\\ \hline
19			& Exterior			 & Combination		& Occlude opening,rebuild, steep angle	to content suppression  & Narrow fog, rebuild, straight stream to fog content suppression		& Flow path between BR1 fire \& BR1 window \\ \hline
20			& Exterior 			 & Smooth bore 		& Steep angle to half bale content suppression 					& Solid stream to half bale content suppression 						& Flow path between BR1 fire \& BR1 window \\ \hline 
\end{tabular}}
...
\centering
\scalebox{0.75}{
\begin{tabular}{|c|C{.09\textwidth}|c|C{0.24\textwidth}|C{0.26\textwidth}|L{0.30\textwidth}|}
\hline
Experiment 	& Fire Attack Method & Nozzle			& Advancement 								 	& Pattern											& Ventilation Parameters 					\\ \hline \hline
21			& Exterior 			 & Smooth bore 		& Steep angle to half bale content suppression 	& Solid stream to half bale content suppression		& Flow paths between front door \& BR1 fire; BR1 fire \& BR1 window \\
\hline
\end{tabular}}
\label{table:Exp21}
\end{table}
...
\section{Need to Cool While Advancing Operating in the Interior}
...
\caption[Thermal Imager H]{Comparison of thermal imager temperature read out to the actual compartment temperatures. Thermal imager from the door location is left and thermal imager from the hallway location is right. The thermocouple temperatures from the adjacent arrays are shown at 7, 5, 3, and 1 ft above the floor (AF). (Experiment 12)}
