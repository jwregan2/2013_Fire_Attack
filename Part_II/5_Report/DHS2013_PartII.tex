...
The transitional attack on a single room of fire was just as effective at cooling the approach to the fire compartment as the water application down the hallway  allowing the suppression crew to rapidly advance to the compartment for final extinguishment. Additionally, it knocked back the room of fire where the initial water application is applied to reduce temperatures in that room (Figure \ref{fig:Thermal_Classes_Approach_Transitional}).
