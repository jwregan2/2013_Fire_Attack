...
Experiment~?? included an exterior attack at the window of Bedroom~?. After approximately ? seconds of flow, the nozzle was advanced past the window and water was applied in a ``whip'' motion for ? seconds. Some technical panel members noticed that flame reappeared in the fire room almost immediately following the application of water in the ``whip'' pattern and inquired if applying water in the ``whip'' pattern significantly affects fire regrowth.   \\
