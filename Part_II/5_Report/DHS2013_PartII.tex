...
% Exterior Flow [min:sec] - Total flow time for exterior attack, start of intial knock down to end of respective whip. 
% Exterior Travel [min:sec] - Total suppression crew movement time exterior of the structure in transitional attack, starting at window 1 location and ending at the front door entrance location. \\
% "Door Read" [min:sec] - Total time spent assessing the fire growth from the front door, starting at door open and ending at entrance to the structure. \\
% Interior Flow [min:sec] - Total flow time for interior attack, starting at intial flow (beginning of the hallway) and ending at final flow (end of hallway). \\
% Interior Travel [min:sec] - Total suppression crew movement time interior of the stucture, starting at the beginning of the hallway location ending at the end of the hallway location. \\
% Victim 4 [min:sec] - Total time the suppression crew took to reach the location of Victim 4, from intial attack to location of Victim 4. \\
% Victim 1 [min:sec] - Total time the suppression crew took to reach the locaiton of Victim 1, from intial attack to location of Victim 1. \\
% Tacic Time [min:sec] - Total time from intial intervention (exterior or interior flow) to final intervention (final flow or end of hallway location). \\
...
24		& Two Vent   	& Fog Whip Both Rooms & 00:43  & 00:18  & 00:13  & N/A    & 00:14  & 01:42  & 01:11  & 01:22 \\ \hline \hline
