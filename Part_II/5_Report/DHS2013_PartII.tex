...
Committing a suppression crew to the front door with a hoseline to locate an suppress the fire may be the most effective way to control the ventilation while searching for and extinguishing the fire. If this tactic is chosen further considerations should be door control as identified by Kerber in 2013 \cite{UL_VerticalVent}, flowing while moving versus shutting down to move (Section \ref{tc:flow_vs_shutdown}, using your stream to cool as you approach the fire (Section \ref{tc:cool_as_you_advance}) and what effect that stream has on the flow paths within the structure (Section \ref{tc:water_impact_flowpath}).
...
\section[Steam is a bi-product of combustion]{Steam is a Bi-Product of Combustion, Suppressing Water is not Drastically Increasing Moisture in the Environment}
