...
Consideration should be given to the line used for final interior. The crew should utilize the most rapid method of transitioning. In some instances this will be by relocating the initial attack line to the interior, in others it may be deploying and additional line for the interior suppression. If more than one crew is available, consideration should be given to conducting simultaneous exterior application and interior advancement. The initial application of water during the transitional attack was shown to reduce not only the fire room temperature but temperatures in adjacent spaces as well.  
