...
\section{Ability to Influsnce the Flow of Prodcuts of Combustion}
...
\subsection{Interior}
The velocity probes at the start of the hallway and the window to the fire room show that flowing water down the hallway has the ability to stop the flow of smoke out of the hallway and create a uniderictional vent at the window.   
...
\begin{figure}[H]
\centering
\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Tactical_Considerations/Flow_vs_Shutdown/Experiment_2/Bedroom_1}
\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Tactical_Considerations/Flow_vs_Shutdown/Experiment_6/Bedroom_1}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Tactical_Considerations/Flow_vs_Shutdown/Experiment_9/Bedroom_1}
\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Tactical_Considerations/Flow_vs_Shutdown/Experiment_10/Bedroom_1}
...
With an additional room of fire in the two rooms of fire with two window vents opposite as seen in Figure \ref{fig:Flow_vs_Shut_Two_Vent_Fire_Temp} the additional energey being released from the fire results in more difficulty in cooling the fire compartment.  

\begin{figure}[H]
\centering
\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Tactical_Considerations/Flow_vs_Shutdown/Experiment_13/Bedroom_1}
\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Tactical_Considerations/Flow_vs_Shutdown/Experiment_14/Bedroom_1}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Tactical_Considerations/Flow_vs_Shutdown/Experiment_2/Start_Hall_Flow}
\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Tactical_Considerations/Flow_vs_Shutdown/Experiment_6/Start_Hall_Flow}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Tactical_Considerations/Flow_vs_Shutdown/Experiment_7/Start_Hall_Flow}
\includegraphics[width=0.495\textwidth]{../0_Images/Script_Figures/Tactical_Considerations/Flow_vs_Shutdown/Experiment_8/Start_Hall_Flow}
