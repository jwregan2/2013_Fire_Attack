...
In the single room fires with no ventilation the two approach tactics were utilized. Figure \ref{fig:Vent_Profile-No_Vent} represents the no ventilation configuration where all exterior windows/doors were closed. Figure 
