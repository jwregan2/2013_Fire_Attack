...
\begin{figure}[H]
\centering
\includegraphics[width=.75\textwidth]{0_Images/Ranch_Pictures/Report_ISO_Pallets.jpg}
\caption{Training Fuel Experiment Layout}
\label{figure:ranchexp2_floorplan}
\end{figure}
