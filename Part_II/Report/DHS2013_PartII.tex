...
The experiments were grouped by the ventilation profile which existed prior to fire department interaction. Each group of experiments were compared in order to determine repeatability and the applicability of comparing the experiments. 

\subsection{Temperature}
The fire room temperatures and temperatures remote from the fire room were compared for each ventilation profile. 

\subsection{Gas Concentration}
