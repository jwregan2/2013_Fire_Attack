...
The experiments were grouped into three groups by ventilation profile prior to fire department interaction. Each group of experiments were compared in order to determine repeatability and the applicability of comparing th experiments within each group. Looking at temperature, gas concentration and 
