...
Line_Colors = {1:'green', 2:'red',3:'blue',4:'pink',5:'lightgreen',6:'darkblue',7:'goldenrod',8:'darksalmon',9:'cyan',10:'chocolate',11:'black',12:'crimson'}
...
for experiment in experiments:
	...
	if not '.DS_Store' in experiment:
		...
		save_location = output_location + Test_Name + '/'
		...
		for chart in charts.index:
			...
			output_file(save_location + chart + ".html", title=chart.replace('_',' '))
