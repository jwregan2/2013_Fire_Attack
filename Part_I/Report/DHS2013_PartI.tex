...
\begin{document}
	...
	\begin{titlepage}
		...
		\AddToShipoutPictureFG*{\AtPageUpperLeft{\raisebox{-\height}{\includegraphics[width=7in]{Figures/General/TitlePagePhotoNew.png}}}} 
...
\begin{figure} [H]
	\centering
	\begin{tabular}{c c}
		\subfloat[Pressure Transducer Box]{\includegraphics[height = 2.5in]{../0_Images/Instrumentation/BDPbox.jpg}} &
		\subfloat[Bi-Directional Probe Array]{\includegraphics[height = 2.5in]{../0_Images/Instrumentation/BDParraydelco.jpg}} \\
	\end{tabular}
...
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Manufacturer_1_5_Combination_Nozzle_95gpm_100psi.png} &
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Manufacturer_1_5_Combination_Nozzle_150gpm_50psi.png} \\
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Manufacturer_1_5_Combination_Nozzle_150gpm_75psi.png} &
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Manufacturer_1_5_Combination_Nozzle_150gpm_100psi.png} \\
\end{tabular*}
...
\begin{figure}[!ht]
\begin{tabular*}{\textwidth}{lr}
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Manufacturer_1_5_Smooth_Bore_Nozzle_7_8_150gpm_50psi.png} &
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Manufacturer_1_5_Smooth_Bore_Nozzle_15_16_180gpm_50psi.png} \\
\end{tabular*}
\centering
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Manufacturer_1_5_Smooth_Bore_Nozzle_1_210gpm_50psi.png} 
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=4in]{../Entrainment_Analysis/Figures/Opening_Occlusion.png}
...
\begin{figure}[!ht]
\begin{tabular*}{\textwidth}{lr}
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Vent_Configuration_1_5_Combination_Nozzle_Interior_No_Door_Top.png} &
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Vent_Configuration_1_5_Combination_Nozzle_Interior_Controlled_Door.png} \\
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Vent_Configuration_1_5_Combination_Nozzle_Interior_Single_Door_Top.png} &
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Vent_Configuration_1_5_Combination_Nozzle_Interior_Double_Door_Top.png} \\
\end{tabular*}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=4in]{../Entrainment_Analysis/Figures/Vent_Configuration_1_5_Smooth_Bore_Nozzle_Interior.png}
...
\begin{figure}[!ht]
\begin{tabular*}{\textwidth}{lr}
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Vent_Configuration_1_5_Combination_Nozzle_Exterior_No_Door_Top.png} &
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Vent_Configuration_1_5_Combination_Nozzle_Exterior_Single_Window_Top.png} \\
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Vent_Configuration_1_5_Combination_Nozzle_Exterior_Single_Door_Top.png} &
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Vent_Configuration_1_5_Combination_Nozzle_Exterior_Double_Door.png} \\
\end{tabular*}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=4in]{../Entrainment_Analysis/Figures/Vent_Configuration_1_5_Smooth_Bore_Nozzle_Exterior.png}
...
\begin{figure}[!ht]
\begin{tabular*}{\textwidth}{lr}
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Vent_Configuration_1_5_Combination_Nozzle_Transitional.png} &
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Vent_Configuration_1_5_Smooth_Bore_Nozzle_Transitional.png} \\
\end{tabular*}
...
\begin{figure}[!ht]
\begin{tabular*}{\textwidth}{lr}
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Vent_Configuration_2_5_Combination_Nozzle_Exterior.png} &
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Vent_Configuration_2_5_Smooth_Bore_Nozzle_Exterior.png} \\
\end{tabular*}
...
\begin{figure}[!ht]
\begin{tabular*}{\textwidth}{lr}
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Vent_Configuration_PM_Combination_Nozzle_Exterior.png} &
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Vent_Configuration_PM_Smooth_Bore_Nozzle_Exterior.png} \\
\end{tabular*}
...
% \begin{figure}[!ht]
% 	\centering
% 	\includegraphics[width=4in]{../Entrainment_Analysis/Figures/Vent_Configuration_1_5_Combination_Nozzle_Interior_Controlled_Door.png}
...
% \begin{figure}[!ht]
% 	\centering
% 	\includegraphics[width=4in]{../Entrainment_Analysis/Figures/Vent_Configuration_1_5_Combination_Nozzle_Interior_Double_Door_Top.png}
...
% \begin{figure}[!ht]
% 	\centering
% 	\includegraphics[width=4in]{../Entrainment_Analysis/Figures/Vent_Configuration_1_5_Combination_Nozzle_Interior_Single_Door_Top.png}
...
% \begin{figure}[!ht]
% 	\centering
% 	\includegraphics[width=4in]{../Entrainment_Analysis/Figures/Vent_Configuration_1_5_Combination_Nozzle_Interior_No_Door_Top.png}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=4in]{../Entrainment_Analysis/Figures/Nozzle_Movement_Comparison_1.png}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=4in]{../Entrainment_Analysis/Figures/Total_Entrainment_1_5_Combination_Nozzle_Interior.png}
...
\begin{figure}[!ht]
\begin{tabular*}{\textwidth}{lr}
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Total_Entrainment_1_5_Combination_Nozzle_Interior_Patterns.png} &
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Total_Entrainment_1_5_Smooth_Bore_Nozzle_Interior_Patterns.png} \\
\end{tabular*}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=4in]{../Entrainment_Analysis/Figures/Nozzle_Movement_Comparison_2.png}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=4in]{../Entrainment_Analysis/Figures/Setback_Distance_Comparison.png}
...
\begin{figure}[!ht]
\begin{tabular*}{\textwidth}{lr}
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Total_Entrainment_1_5_Combination_Nozzle_Interior.png} &
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Total_Entrainment_1_5_Smooth_Bore_Nozzle_Interior.png} \\
\end{tabular*}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Total_Entrainment_1_5_Smooth_Bore_Nozzle_Exterior.png}
...
\begin{figure}[!ht]
\begin{tabular*}{\textwidth}{lr}
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Total_Entrainment_2_5_Combination_Nozzle_Interior.png} &
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Total_Entrainment_2_5_Smooth_Bore_Nozzle_Interior.png} \\
\end{tabular*}
...
\begin{figure}[!ht]
\begin{tabular*}{\textwidth}{lr}
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Total_Entrainment_2_5_Combination_Nozzle_Exterior.png} &
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Total_Entrainment_2_5_Smooth_Bore_Nozzle_Exterior.png} \\
\end{tabular*}
...
\begin{figure}[!ht]
\begin{tabular*}{\textwidth}{lr}
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Total_Entrainment_MS_Combination_Nozzle_Interior.png} &
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Total_Entrainment_MS_Smooth_Bore_Nozzle_Interior.png} \\
\end{tabular*}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Total_Entrainment_MS_Combination_Nozzle_Interior_500gpm_100psi.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=6in]{../Entrainment_Analysis/Figures/Vent_Configuration_1_5_Combination_Nozzle_Interior.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=6in]{../Entrainment_Analysis/Figures/Vent_Configuration_1_5_Smooth_Bore_Nozzle_Interior.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=6in]{../Entrainment_Analysis/Figures/Vent_Configuration_1_5_Combination_Nozzle_Exterior.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=6in]{../Entrainment_Analysis/Figures/Vent_Configuration_1_5_Smooth_Bore_Nozzle_Exterior.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=6in]{../Entrainment_Analysis/Figures/Vent_Configuration_1_5_Combination_Nozzle_Transitional.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=6in]{../Entrainment_Analysis/Figures/Vent_Configuration_1_5_Smooth_Bore_Nozzle_Transitional.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=6in]{../Entrainment_Analysis/Figures/Vent_Configuration_2_5_Combination_Nozzle_Exterior.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=6in]{../Entrainment_Analysis/Figures/Vent_Configuration_2_5_Smooth_Bore_Nozzle_Exterior.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=6in]{../Entrainment_Analysis/Figures/Vent_Configuration_PM_Combination_Nozzle_Exterior.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=6in]{../Entrainment_Analysis/Figures/Vent_Configuration_PM_Smooth_Bore_Nozzle_Exterior.png}
...
\begin{figure}[!ht]
\begin{tabular*}{\textwidth}{lr}
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Room_Configuration_1_5_Combination_Nozzle_Interior_1.png} &
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Room_Configuration_1_5_Combination_Nozzle_Interior_4.png} \\
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Room_Configuration_1_5_Combination_Nozzle_Interior_2.png} &
\includegraphics[width=3.5in]{../Entrainment_Analysis/Figures/Room_Configuration_1_5_Combination_Nozzle_Interior_3.png} \\
\end{tabular*}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=6in]{../Entrainment_Analysis/Figures/Room_Configuration_1_5_Combination_Nozzle_Exterior.png}
...
\includegraphics[width=3.2in]{../ADD_Analysis/Figures/15-12-07_145156_Datafile_Straight_Stream_Exterior.png} &
\includegraphics[width=3.2in]{../ADD_Analysis/Figures/15-12-07_145842_Datafile_Straight_Stream_Exterior.png} \\
\includegraphics[width=3.2in]{../ADD_Analysis/Figures/15-12-07_150349_Datafile_Straight_Stream_Exterior.png} &
\includegraphics[width=3.2in]{../ADD_Analysis/Figures/15-12-07_151001_Datafile_Straight_Stream_Exterior.png} \\
\includegraphics[width=3.2in]{../ADD_Analysis/Figures/15-12-07_151630_Datafile_Straight_Stream_Exterior.png} &
\includegraphics[width=3.2in]{../ADD_Analysis/Figures/15-12-07_152028_Datafile_Straight_Stream_Exterior.png} \\
\end{tabular*}}
...
\includegraphics[width=3.2in]{../ADD_Analysis/Figures/15-12-08_113237_Datafile_Straight_Stream_Exterior.png} &
\includegraphics[width=3.2in]{../ADD_Analysis/Figures/15-12-08_113716_Datafile_Straight_Stream_Exterior.png} \\
\includegraphics[width=3.2in]{../ADD_Analysis/Figures/15-12-08_114309_Datafile_Straight_Stream_Exterior.png} &
\includegraphics[width=3.2in]{../ADD_Analysis/Figures/15-12-08_114905_Datafile_Straight_Stream_Exterior.png} \\
\includegraphics[width=3.2in]{../ADD_Analysis/Figures/15-12-08_120311_Datafile_Straight_Stream_Exterior.png} &
\includegraphics[width=3.2in]{../ADD_Analysis/Figures/15-12-08_121011_Datafile_Straight_Stream_Exterior.png} \\
\end{tabular*}}
...
\begin{figure}[ht]
\begin{tabular*}{\textwidth}{lr}
\includegraphics[width=3.2in]{../ADD_Analysis/Figures/15-12-10_084506_Datafile_Straight_Stream_Exterior.png} &
\includegraphics[width=3.2in]{../ADD_Analysis/Figures/15-12-10_084944_Datafile_Straight_Stream_Exterior.png} \\
\end{tabular*}
\centering
\includegraphics[width=3.2in]{../ADD_Analysis/Figures/15-12-10_085408_Datafile_Straight_Stream_Exterior.png}
...
\scalebox{0.8}{
\begin{tabular*}{\textwidth}{lr}
\includegraphics[width=3.2in]{../ADD_Analysis/Figures/15-12-09_101601_Datafile_Straight_Stream_Interior.png} &
\includegraphics[width=3.2in]{../ADD_Analysis/Figures/15-12-09_102308_Datafile_Straight_Stream_Interior.png} \\
\includegraphics[width=3.2in]{../ADD_Analysis/Figures/15-12-09_102830_Datafile_Straight_Stream_Interior.png} &
\includegraphics[width=3.2in]{../ADD_Analysis/Figures/15-12-09_103306_Datafile_Straight_Stream_Interior.png} \\
\end{tabular*}}
\centering
\scalebox{0.8}{
\includegraphics[width=3.2in]{../ADD_Analysis/Figures/15-12-09_103649_Datafile_Straight_Stream_Interior.png}}
