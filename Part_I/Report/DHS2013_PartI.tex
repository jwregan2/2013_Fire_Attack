...
\begin{tabular}{ccccc}
\toprule[1.5pt]
{\textbf{Hose Stream Type}} & {\textbf{Nozzle Direction}} & {\textbf{Nozzle Movement}} & {\textbf{Nozzle Pressure (psi)}} & \textbf{Flow Rate (gpm)} \\ 
\midrule
...
\begin{tabular}{lccccc}
\toprule[1.5pt]
{\textbf{Floor Position}}& {\textbf{Hose Stream Type}} & {\textbf{Nozzle Movement}} & {\textbf{Nozzle Direction}} & {\textbf{Nozzle Pressure (psi)}} & \textbf{Flow Rate (gpm)} \\ 
\midrule
...
The intent of the water flow testing was to determine the location of where water within the compartment as a function of several common fire service equipment configurations.
