...
\caption[Distance From the Opening has an Impact on Air Entrainment]{Distance from the opening has an impact on air entrainment.}
...
\begin{figure}[!ht]
\begin{tabular*}{\textwidth}{lr}
\includegraphics[width=0.45\columnwidth]{Script_Figures/Entrainment/Total_Entrainment_1_5_Combination_Nozzle_Interior_All_Patterns} &
\includegraphics[width=0.45\columnwidth]{Script_Figures/Entrainment/Total_Entrainment_1_5_Smooth_Bore_Nozzle_Interior_All_Patterns} \\
\end{tabular*}
